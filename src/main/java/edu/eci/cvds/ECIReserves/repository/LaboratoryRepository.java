...
public interface LaboratoryRepository extends MongoRepository<Laboratory, String> {
    ...
    List<Laboratory> findByAvailableTrue();
    List<Laboratory> findByTimeSlotsStartTimeLessThanEqualAndTimeSlotsEndTimeGreaterThanEqual(LocalTime startTime, LocalTime endTime);
}
